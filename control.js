var user={
	num : ["321",'905',"008","112","928","898","505","125"],
	senha: ["mel","estrela","dipanda","fugete","escuro","abelha","kill","natal"],
	time: [new Date("2024/12/4"),new Date("2024/12/30"),new Date("2024/12/7"),new Date("2024/11/30"),new Date("2024/12/10"),new Date("2024/12/1"), new Date("2024/12/10"),new Date("2024/12/23") ]
};
var casaAposta=0, h1;
