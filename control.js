var user={
	num : ['768',"980","333","891","888","501"],
	senha: ["estrela","azul","festa","Brilho","vida","pacote"],
	time: [new Date("2024/10/28"),new Date("2024/10/25"),new Date("2024/10/27"),new Date("2024/10/24"),new Date("2024/11/21"), new Date("2024/10/25") ]
};
var casaAposta, h1;
