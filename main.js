...
alcanse: ["5x+","5x+","5x 10+","5x+","5x 10+","5x+","5x 10+","5x+"]};
 h1 = {min : [9,12,22,26,29,40,47,49,55,56],
alcanse: ["5x+","5x+","5x 10 35x 50x+","5x+","5x 10+","5x+","5x 10+","5x+"]};
 h2 = {min : [9,25,35,40,47],alcanse: ["5x 20x 50x+","5x 20x 50x+","5x 20x 50x+","5x 20x 50x+"]};
 h3 = {min : [24,26,29,35,42,55],alcanse: ["5x 20x 50x+","5x 20x 50x+"]};
 h4 = {min : [9,11,12,21,22,29,30,33,40,44,47,49,55,58],
alcanse: ["5x+","5x 10x 35x 50x+","5x 10+","5x+","5x 10+","5x+","5x 10+","5x+"]};
 h5= {min : [12,23,25,30,40,49,54],alcanse: ["5x 20x 50x+","5x 20x 50x+","5x+"]};
...
alcanse: ["5x 10x 25x 35x+","5x 15x 25x+","5x 15x 25x+","8x 11x",'10x 20x 40x', '5x 7x 12x', '5x 9x', '5x 7x', '5x 7x', '10x 20x 30x 60x', '7x 10x', '5x 10x',"5x 10x","5x 10x","5x 10x"]};
 ...
 h10 = {min : [1, 4,7, 8,10,15,22, 24,28,31,34, 37, 43,45,46,48,52,53,57],
alcanse: ['10x 15x 20x','10x 14x 19x','5x 7x',"5x 10x","5x 10x", '7x 12x 15x','8x 18x 25x','5x 6x','5x 9x 11x', '5x 7x', '20x 50x 100x+','10x 20x 35x','10x 20x 35x','7x 10c','10x 20x','8x 15x', '5x','10x 20x 50x 80x']};
 h11 = {min : [00,1,3,7,8,15,17,25,26,29,34,37,43,46,48,52],alcanse: ['5x 20x 40x 100x',"5x 20x 50x+","5x 20x 50x+","5x 20x 50x+"]};
 h12 = {min : [5,8,9,17,26,32,34,37,40,43,45,46,52,56],
alcanse: ['5x 20x 40x 100x',"5x 20x 50x+","5x 20x 50x+","5x 20x 50x+"]};
 h13 = {min : [3,6,7,8,14,20,22,24,26,27,29,32,35,38,39, 41,42, 45,47,49, 52, 53, 55,57, 58],
alcanse: ["5x 10x", "5x 7x", "5x 7x", "5x 10x 50x", "5x 10x","5x 10x", "5x 10x 17x","5x 12x"]};
 h14 = {min : [00,1,4,6,9,11,13,15,17,23,25,37,41,42,52,54,57,58],
alcanse: ["5x 10x 17x","5x 12x","5x 10x","5x+","5x 10x","5x 10x 25x 50x+","5x 10x 20x 35x+", "5x 10x","5x 20x 50x+","5x 10x 15x","5x 10x"]};
 h15= {min : [3,5,10,12,13,15,18,24,25,42,44,52,55],alcanse: ["5x","5x 10x","5x 10x","5x 10x","5x 10x",0,"5x 15x 30x+","5x 10x 15x+"]};
 h16 = {min : [00,2,3,5,10,16,17,25,31,33,35,37,44,47],
alcanse: ["5x 10x 30x+","5x","5x 10x 30x 50x+",0,0,0,0,0,0,0,0,0,"5x 10x 20x+",0]};
 h17 = {min :  [5,12,14,17,20,21,23,29,30,35,39,40,54,52,56,57,59],
alcanse: ["5x+","5x+","5x+","5x 10x","5x 10+","5x+","5x 10+","5x+","5x 10+","5x+","5x","5x 10x+","5x 10x+","5x 10x+","5x 10x+"]};
 ...
 h00 = {min : [],alcanse: []};
 h1 = {min : [14,33,37,41,59],alcanse: ["5x 20x 50x+"]};
 h2 = {min : [26,36,41,48,58],alcanse: ["5x 20x 50x+","5x 20x 50x+","5x 20x 50x+"]};
 h3 = {min : [11,14,44,46,47],alcanse: ["5x 20x 50x+"]};
 h4 = {min : [17,54],alcanse: []};
 h5= {min : [12,15,22,23,24,27,29,32,46,47,48,49,51,54,55,56,57],alcanse: ["5x 20x 50x+","5x 20x 50x+"]};
 ...
 h13 = {min : [4,7,11,13,22,24,35,38,41, 43, 45, 49,55,58, 59],alcanse: ["5x", "5x 10x","5x 12x", "5x 15x", "5x 10x 20x", "5x 10x", "5x"]};
 h14 = {min : [3,6,8,11,12, 13, 17,24,27,34,35,39,43,45,47,48,51],
 ...
 h15= {min : [0,3,6,12,14,16,20,59],alcanse: ["5x 10x 20x+","5x 10x 15x+","5x+","5x+","5x+","5x+","5x+"]};
 h16 = {min : [7,11,38,40,45,48,49,52,53,56,59],alcanse: ["5x 10x 20x+","5x 10x 15x+","5x 10x+","5x 10x+","5x+","5x+","5x+","5x"]};
 h17 = {min : [1,3,6,7,11,16,18,23,40,41,55,56],alcanse: ["5x 10x","5x 10x 20x+","5x 10x 15x+","5x+","5x+","5x+","5x+","5x+"]};
